...
var s2Filtered = s2
.filter(ee.Filter.date("2024-05-01", "2024-09-01")) 
...
.filter(ee.Filter.date("2024-03-01", "2024-06-01"))
.filter(ee.Filter.bounds(roi))
.filter(ee.Filter.lte("CLOUDY_PIXEL_PERCENTAGE", 10))
...
.filter(ee.Filter.date("2024-09-01", "2024-11-01"))
.filter(ee.Filter.bounds(roi))
.filter(ee.Filter.lte("CLOUDY_PIXEL_PERCENTAGE", 10))
...
var sampleCollection = forest_pale_2024.merge(grassland_pale_2024).merge(build_up_land_pale_2024).merge(bare_rock_pale_2024).merge(crops_pale_2024).merge(bare_land_pale_2024).merge(sparse_vegetation_pale_2024);
...
features: Training_Samples_Pale_2025_Scaled, 
...
//Map.addLayer(classifiedImage.clip(polygon), classesVis, "lulc 2024");
...
//description: "pale_24_lulc", 
//folder: "earthengine", 
//fileNamePrefix: "pale_lulc_24", 
//region: polygon, 
//scale: 10, 
//maxPixels: 1e13});
...
//folder: "earthengine", 
//fileNamePrefix: "Pale_LULC_Accuracy_Report_2024", 
//fileFormat: "CSV"
//});
...
//description: "pale_RF_24_lulc", 
//folder: "earthengine", 
//fileNamePrefix: "pale_RF_lulc_24", 
//region: palePolygon, 
//scale: 10,
//maxPixels: 1e13});
...
//description: "Area_km2_2024", 
//folder: "earthengine", 
//fileNamePrefix: "Area_Pale_RF_2024"});



//FINAL VALIDATION OF CLASSIFICATION RESULTS

var validationDataSokolac = forest_sokolac_2024.merge(grassland_sokolac_2024).merge(build_up_land_sokolac_2024).merge(bare_rock_sokolac_2024).merge(crops_sokolac_2024).merge(bare_land_sokolac_2024).merge(sparse_vegetation_sokolac_2024);
...
//description: "sokolac_RF_24_lulc", 
//folder: "earthengine", 
//fileNamePrefix: "sokolac_RF_lulc_24", 
...
//description: "Error_Matrix", 
//folder: "earthengine", 
//fileNamePrefix: "Sokolac_LULC_Accuracy_Report_2024", 
//fileFormat: "CSV"
//});
...
//description: "Area_km2_2024", 
//folder: "earthengine", 
//fileNamePrefix: "Area_Sokolac_RF_2024"});
...
//Map.addLayer(classifiedImage2.clip(polygon), classesVis, "lulc 2024");
...
//description: "pale_GBM_24_lulc", 
//folder: "earthengine", 
//fileNamePrefix: "pale_GBM_lulc_24", 
//region: palePolygon, 
//scale: 10,
//maxPixels: 1e13});
...
//description: "Area_km2_2024", 
//folder: "earthengine", 
//fileNamePrefix: "Area_Pale_GBM_2024"});
...
//Export.table.toDrive({
//collection: sortedResult,
//description: 'GBM_Hyperparameter_Tuning_Results_24',
//fileFormat: 'CSV',
...
//description: "sokolac_GBM_24_lulc", 
//folder: "earthengine", 
//fileNamePrefix: "sokolac_GBM_lulc_24", 
//region: sokolacPolygon, 
//scale: 10,
//maxPixels: 1e13});
...
//description: "Area_km2_2024", 
//folder: "earthengine", 
//fileNamePrefix: "Area_Sokolac_GBM_2024"});
...
//description: 'GBM_LULC_Accuracy_Report_2024',
//folder: 'earthengine',
//fileNamePrefix: 'LULC_GBM_Metrics_Pale_Sokolac_2024',
//fileFormat: 'CSV',
...
description: "CohenD_DomainShift_sve_klase_2024",
fileFormat: "CSV",
folder: "earthengine",
...
description: "DomainShift_Statistika_sve_klase_2024",
fileFormat:  "CSV",
folder:      "earthengine",
